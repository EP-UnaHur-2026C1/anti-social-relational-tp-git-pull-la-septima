...
const {
    ...
    updatePostImage,
    deletePostImage
} = require('../controllers/post_images.controller');
const {
    validatePostImagestId,
    validatePostByImageId
} = require('../middlewares/post_images.middleware');
...
router.put('/user/:id/post/:id_post/images/:id_pi', upload.single('image'), validateIdsAndPostByUser, validatePostImagestId, validatePostByImageId, updatePostImage);
